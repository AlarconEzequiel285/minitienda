...
<div className="hidden md:flex space-x-3">
  ...
  <button onClick={handleComprasClick} className="text-sm font-medium text-black hover:scale-110 transition-transform">MIS COMPRAS</button>
      ...
      {/* Main content */}
      <main className="flex-1 flex flex-col items-center px-4 py-10 w-full pt-24">
        ...
        {cartWithProducts.length === 0 ? (
          ...
          <div className="flex flex-col gap-6 w-full max-w-3xl">
            {cartWithProducts.map(item => (
              <div
                key={item.productId}
                className={`flex items-center gap-6 bg-gray-200 p-4 rounded-xl shadow transition-all duration-300 transform ${
            ...
            <div className="bg-gray-200 p-4 rounded-xl shadow flex flex-col gap-2 text-black mt-4">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-semibold">{shipping === 0 ? "GRATIS" : `$${shipping.toLocaleString()}`}</span>
              </div>
